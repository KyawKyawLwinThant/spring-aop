...
public class Main {
    public static void main(String[] args) {
        ...
        CurrencyService currencyService=context
                .getBean(CurrencyService.class);
        AlterCurrencyService alterCurrencyService=context
                .getBean(AlterCurrencyService.class);
        MyCurrencyService myCurrencyService=context
                .getBean(MyCurrencyService.class);
